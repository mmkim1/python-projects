...
sandwichingredients=["bacon,lettuce,tomato,bread","cheddar,bread","avocado,tomato,lettuce,mayo,bread,chicken,bacon","bread,tomato,redonion,cucumber,lettuce,pepper,oil,avacado"]
...
def saladselection():
    ...
    print("Please select your dietary restrictions/choices(Vegan(V), vegetarian(VG), gluten free(GF), lactose free(LF), or None(N)))")
    print(" ")
...
def soupselection():
    ...
    (Vegan(V), vegetarian(VG), gluten free(GF), or lactose free(LF)))""")
    print(" ")
    restriction=input("Enter restriction/choice here:")
    if restriction=="V" or restriction=="v":
        print("Vegan selected")
